...
async function checkAuth() {
  try {
    ...
    if (session) {
      ...
      const dashboardLinkContainer = document.getElementById("roleDashboardLink");
      if (dashboardLinkContainer) {
        ...
        if (userProfile?.role === 'admin') {
          ...
          adminLink.innerHTML = "🛠️ แอดมิน";
          adminLink.style.cssText = "color: #e74c3c; font-weight: 600; margin-left: 12px; text-decoration: none;";
          dashboardLinkContainer.appendChild(adminLink);
        }
        
        if (techProfile) {
          const techLink = document.createElement("a");
          techLink.href = "technician-dashboard.html";
          techLink.innerHTML = "👨‍🔧 แดชบอร์ดช่าง";
          techLink.style.cssText = "color: #10b981; font-weight: 600; margin-left: 12px; text-decoration: none;";
          dashboardLinkContainer.appendChild(techLink);
        }
      }
    } else {
